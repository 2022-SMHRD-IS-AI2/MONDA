		...
		<div class="inner">
			<div class="profileWrap">
				<div class="profile f_left">
					<a href=""><img src="./images/<%if(loginMember == null){%>profile_img.png<%}
					else{%><%=loginMember.getM_profile()%><%} %>" /></a>
					<div class="profile_txt f_right">
						<p><%if(loginMember == null){ %><a href="">로그인/회원가입</a>
						<%}else{%><%=loginMember.getM_name() %><br><a href="logoutCon">로그아웃</a><br>
