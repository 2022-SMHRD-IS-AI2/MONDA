...
<head>
	...
	<!-- workspace css
	1. 스크롤 영역 조절
	2. 드래그 가능한 구역 마우스 커서 변경 X
	3. 드래그 시 오퍼러티 0.5
	4. z-index 선언을 위한 포지션 지정
	5. textarea 출력 구역용 css  -->
	<style>
												...
												<div class="scroll_box container" id="endSpace">
													...
													<div class="mt-2 draggable mb-8" draggable="true">
														<div
															...
															<div class="text-xs text-gray-400 f_right f_icon">
																<i onclick="w_modify()">M</i>
																<i onclick="w_delete()">X</i>
															</div>
															...
															<div style="text-align : center">
																<span
																	class="self-start text-xs text-gray-400">yyyy-mm-dd</span>
																➔ <span
																	class="self-start text-xs text-gray-400">yyyy-mm-dd</span>
															</div>
													...
													<div class="mt-2 draggable mb-8" draggable="true">
														<div
															...
															<div></div>
															<p class="print_textarea">테스트테스트테스트테스트테스트테스트테스트테스트테스트테스트</p>
														</div>
													</div>
											</section>
									</div>
